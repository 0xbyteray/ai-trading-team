...
| WEEX_API_KEY | WEEX API key | Required for WEEX execution |
| WEEX_API_SECRET | WEEX API secret | Required for WEEX execution |
| WEEX_PASSPHRASE | WEEX passphrase | Required for WEEX execution |
